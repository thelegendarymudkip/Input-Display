...
You need to have your controller plugged in to port 0, at the moment. This is likely to change in the future.
...
and the last line is the Blue value of the background. Don't bother trying to overflow the colour data, a bitwise and
operation with 255 (equivalent to a mod 256 operation) is performed on the values from the file.